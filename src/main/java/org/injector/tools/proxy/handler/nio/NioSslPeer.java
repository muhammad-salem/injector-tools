...
public abstract class NioSslPeer {
    ...
    protected abstract void read(SSLEngine engine, SocketChannel readFromChannel, Consumer<ByteBuffer> bufferConsumer) throws Exception;
        ...
        while (handshakeStatus != SSLEngineResult.HandshakeStatus.FINISHED && handshakeStatus != SSLEngineResult.HandshakeStatus.NOT_HANDSHAKING) {
            ...
            case NEED_UNWRAP:
                ...
                try {
                    ...
                    log.error("1.A problem was encountered while processing the data that caused the SSLEngine to abort. Will try to properly close connection...");
                    engine.closeOutbound();
                    handshakeStatus = engine.getHandshakeStatus();
                    break;
                }
            ...
            case NEED_WRAP:
                ...
                try {
                    ...
                    log.error("2.A problem was encountered while processing the data that caused the SSLEngine to abort. Will try to properly close connection...");
                    engine.closeOutbound();
                    handshakeStatus = engine.getHandshakeStatus();
                    break;
                }
